...
import {View, Text, TouchableOpacity, StyleSheet, StatusBar, Alert, Modal, ScrollView,} from 'react-native';
...
export default function App() {
  ...
  const saveVisitors = async (updated) => {
    try {
      ...
      console.error('Failed to save visitors:', e);
    }
  };
  ...
  const handleResetData = () => {
    Alert.alert(
      'Reset Demo Data',
      'This will restore all visitors to their original demo state.',
      [
  ...
  return (
    <SafeAreaView style={appStyles.safeArea}>
      ...
      <Preregisterscreen
        onCancel={goToDashboard}
        onSave={(newVisitor) => {
          const updatedList = [newVisitor, ...visitors];
          saveVisitors(updatedList); // This saves to AsyncStorage
          goToDashboard();
...
const appStyles = StyleSheet.create({
  ...
  topBar: {backgroundColor: '#1D4ED8', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 18, paddingVertical: 14,},
  ...
  resetBtn: {backgroundColor: 'rgba(255,255,255,0.15)',borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)',},
  resetBtnText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },

  statsStrip: {flexDirection: 'row', backgroundColor: '#1E40AF', paddingHorizontal: 14, paddingVertical: 10, gap: 8,},
  statChip: {flex: 1, backgroundColor: '#FFFFFF', borderRadius: 10, alignItems: 'center', paddingVertical: 8, borderWidth: 2,},
  statCount: { fontSize: 20, fontWeight: '800' },
  statLabel: { fontSize: 10, color: '#6B7280', fontWeight: '500', marginTop: 1 },

  screenHeader: {backgroundColor: '#1D4ED8', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 14, paddingVertical: 12,},
  backBtn: {backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, width: 80,},
